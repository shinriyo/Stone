...
@Reviser public class InlineCache {
    @Reviser public class DotEx2 extends ObjOptimizer.DotEx {
        ...
        protected void updateCache(OptStoneObject target) {
            ...
            Integer i = classInfo.fieldOIndex(member);
            if (i != null) {
                isField = true;
                index = i;
                return;
    ...
    @Reviser public class AssignEx2 extends ObjOptimizer.AssignEx {
        protected OptClassInfo classInfo = null;
        protected int index;
